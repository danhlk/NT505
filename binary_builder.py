...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        required=False,
        default=Path("/home/containernet/KLTN/Pesidious/Data/malware/018b9e078cd1798279491fa91dd06d38bf01d4f86fbcd8ea9720d0a454a55ce9"),
    )
    parser.add_argument(
        "-a",
        "--adversarial-vector",
...
def binary_builder(
    ...
    if feature_type.lower() == "section":
        ...
        pickle.dump(
            adversarial_imports_dict,
            open(os.path.join(RL_features, adversarial_vector[77:-3] + "_adversarial_imports_set.pk"), "wb"),
        )
        pickle.dump(
            adversarial_sections_set[0],
            open(os.path.join(RL_features, adversarial_vector[77:-3] + "_adversarial_sections_set.pk"), "wb"),
        )
